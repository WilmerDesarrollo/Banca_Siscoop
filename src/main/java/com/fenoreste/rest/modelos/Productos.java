...
private static final long SerialVersionUID=1L;
	...
	public Productos(Integer idproducto, String nombre, Integer idorigen, String cuentaaplica, String cuentavencida,
			String cuentaintord, String cuentaidnc, String cuentaidncres, String cuentaiod, String cuentaintmor,
			String cuentaiva, String cuentarc, String cuentari, Integer tipoproducto, Integer tiporetiro,
			Integer tipocalculo, Integer tasaio, Integer tasaiod, Integer tasaim, Integer iva, Integer ivaim,
			Integer garantias, Integer avales, Boolean reqsocio, Integer tipoamortizacion, Integer maxeventos,
			Integer maxdv, String saldominimo, String saldomaximo, String cuentageprcc, String cuentageprci,
			String cuentaeprcc, String cuentaeprci, String cuentaoimd, String cuentaoima, String cuentaoioa,
			String cuentaivaim, String cuentaivaidncvig, String cuentaivaidncven, String cuentaivappidnc,
			String cuentaintordv, Integer plazomax, Integer tipofinalidad, String activo, String pagodiafijo,
			String cant_aperturas, Integer producto_padre, Integer tasasp, Integer ivasp, String cuentasp,
			String cuentaivasp, String tolerancia_im, String tolerancia_com_no_pago, Double monto_com_no_pago,
			Double comision_apertura, String rango_edad, String evalua_aperturas, String cuentaintmorv,
	...
	public String getCuentaiod() {
		return cuentaiod;
	}


	public void setCuentaiod(String cuentaiod) {
		this.cuentaiod = cuentaiod;
	}
	...
	public String toString() {
		return "Productos [idproducto=" + idproducto + ", nombre=" + nombre + ", idorigen=" + idorigen
				+ ", cuentaaplica=" + cuentaaplica + ", cuentavencida=" + cuentavencida + ", cuentaintord="
				+ cuentaintord + ", cuentaidnc=" + cuentaidnc + ", cuentaidncres=" + cuentaidncres + ", cuentaiod="
				+ cuentaiod + ", cuentaintmor=" + cuentaintmor + ", cuentaiva=" + cuentaiva + ", cuentarc=" + cuentarc
				+ ", cuentari=" + cuentari + ", tipoproducto=" + tipoproducto + ", tiporetiro=" + tiporetiro
				+ ", tipocalculo=" + tipocalculo + ", tasaio=" + tasaio + ", tasaiod=" + tasaiod + ", tasaim=" + tasaim
				+ ", iva=" + iva + ", ivaim=" + ivaim + ", garantias=" + garantias + ", avales=" + avales
				+ ", reqsocio=" + reqsocio + ", tipoamortizacion=" + tipoamortizacion + ", maxeventos=" + maxeventos
				+ ", maxdv=" + maxdv + ", saldominimo=" + saldominimo + ", saldomaximo=" + saldomaximo
				+ ", cuentageprcc=" + cuentageprcc + ", cuentageprci=" + cuentageprci + ", cuentaeprcc=" + cuentaeprcc
				+ ", cuentaeprci=" + cuentaeprci + ", cuentaoimd=" + cuentaoimd + ", cuentaoima=" + cuentaoima
				+ ", cuentaoioa=" + cuentaoioa + ", cuentaivaim=" + cuentaivaim + ", cuentaivaidncvig="
				+ cuentaivaidncvig + ", cuentaivaidncven=" + cuentaivaidncven + ", cuentaivappidnc=" + cuentaivappidnc
				+ ", cuentaintordv=" + cuentaintordv + ", plazomax=" + plazomax + ", tipofinalidad=" + tipofinalidad
				+ ", activo=" + activo + ", pagodiafijo=" + pagodiafijo + ", cant_aperturas=" + cant_aperturas
				+ ", producto_padre=" + producto_padre + ", tasasp=" + tasasp + ", ivasp=" + ivasp + ", cuentasp="
				+ cuentasp + ", cuentaivasp=" + cuentaivasp + ", tolerancia_im=" + tolerancia_im
				+ ", tolerancia_com_no_pago=" + tolerancia_com_no_pago + ", monto_com_no_pago=" + monto_com_no_pago
				+ ", comision_apertura=" + comision_apertura + ", rango_edad=" + rango_edad + ", evalua_aperturas="
				+ evalua_aperturas + ", cuentaintmorv=" + cuentaintmorv + ", cuentaidncmres=" + cuentaidncmres
				+ ", cuentaidncm=" + cuentaidncm + ", cuentaidncmv=" + cuentaidncmv + ", cuentageprcim=" + cuentageprcim
				+ ", cuentaeprcim=" + cuentaeprcim + "]";
	}
